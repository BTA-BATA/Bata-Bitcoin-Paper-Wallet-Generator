"ru": {
	...
	"securitystep0": "Первым делом <strong>скачайте</strong> этот веб-сайт с <a href=\"https://github.com/BTA-BATA/">Github</a>, распакуйте и откройте файл index.html непосредственно с Вашего компьютера. Слишком просто спрятать вредоносный код в 6000+ строках javascript, чтобы украсть Ваш закрытый ключ, а Вам этого вряд ли хочется. Система контроля версий позволяет значительно упростить взаимную проверку исполняемого кода. Для большей безопасности <strong>отключитесь от Интернета</strong> на время создания кошелька.",
	...
	"footersupport": "Поддержать Bata.Money",
	...
	"defaultTitle": "Bata.Money BTA - Универсальный генератор бумажных кошельков для Bata и других криптовалют",
